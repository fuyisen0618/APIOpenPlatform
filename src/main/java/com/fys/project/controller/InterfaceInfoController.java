...
import com.fys.project.common.*;
import com.fys.project.constant.CommonConstant;
import com.fys.project.exception.BusinessException;
import com.fys.project.model.dto.interfaceInfo.InterfaceInfoAddRequest;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        Long idRequestId = idRequest.getId();
        InterfaceInfo interfaceInfo = interfaceInfoService.getById(idRequestId);
        if (interfaceInfo==null){
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        com.fys.ysapiclientsdk.model.User user = new com.fys.ysapiclientsdk.model.User();
        ...
        interfaceInfo1.setId(idRequestId);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest invokeRequest,
        ...
        Long idRequestId = invokeRequest.getId();
        ...
        Ysapiclient tempclient = new Ysapiclient(accessKey, secretKey);
        Gson gson = new Gson();
        com.fys.ysapiclientsdk.model.User user = gson.fromJson(requestParams, com.fys.ysapiclientsdk.model.User.class);
